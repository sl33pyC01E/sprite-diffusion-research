"""Export frozen CLIP text embeddings for the balanced MFFA materialization."""
...
OUTPUT = ROOT / "data/processed/semantic-text/mugen-mffa-openai-clip-vit-b32-c7244be-v1"
