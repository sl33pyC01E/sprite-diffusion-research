"""Run the TMWA causal16 alpha-weight-eight background-cleanliness ablation."""
...
OUTPUT = REPOSITORY / "data/experiments/tmwa-causal16-b64-f8-alpha8-ew1-v1-3000"
ABLATION_CONFIG = replace(CONFIG, alpha_channel_weight=8.0)
...
def main() -> None:
    ...
    guard.require_capacity(2 * 1024**3, label="TMWA alpha8 reserve")
