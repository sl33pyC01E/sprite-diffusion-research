  ...
  return (
    <section className="view studio-view" aria-labelledby="studio-title">
      <div className="studio-copy">
        ...
        <div className="boundary-note"><span className="pulse-dot" /><div><strong>Hosted mode: verified replay</strong><small>Controls select completed artifacts. Effect-only and subject-absent targets are quarantined; live checkpoint inference remains local-GPU research.</small></div></div>
